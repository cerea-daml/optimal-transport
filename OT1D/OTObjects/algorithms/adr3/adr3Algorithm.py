...
class Adr3Algorithm( Algorithm ):
    ...
    def __init__(self, config):
        ...
        prox2 = Prox2Adr3(config, proxCsc)
    ...
    def setState(self, newState):
        ...
        u1 = grid.StaggeredCenteredField( self.config.N , self.config.P ,
                                          stagField, centField )
        
        self.stateN = Adr3State( self.config.N , self.config.P , u1 , u1.copy() , u1.copy() , u1.copy() )
    ...
    def initialize(self):
        ...
        if self.stateN is None:
            ...
            self.stateN   = Adr3State( self.N , self.P , u1 , u1.copy() , u1.copy() , u1.copy() )
            self.stateNP1 = self.stateN.copy()
