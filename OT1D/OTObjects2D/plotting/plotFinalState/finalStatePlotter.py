    ...
    def plot(self):
        ...
        if self.plottingConfig.singleOrMulti == 0:
            ...
            plotFinalState(self.plottingConfig.outputDir[0], self.plottingConfig.figDir, self.plottingConfig.prefixFigNameFinalState,
                           self.plottingConfig.label[0], transparencyFunction, self.plottingConfig.extension, self.plottingConfig.plotFinalStatePlotter,
                           self.plottingConfig.plotFinalStateArgs, self.plottingConfig.plotFinalStateArgsInit, 
                           self.plottingConfig.plotFinalStateArgsFinal, self.plottingConfig.EPSILON)

        elif self.plottingConfig.singleOrMulti == 1:

            plotFinalStateMultiSim(self.plottingConfig.outputDirList, self.plottingConfig.figDir, self.plottingConfig.prefixFigNameFinalState, 
                                   self.plottingConfig.labelsList, transpFun, self.plottingConfig.extension, self.plottingConfig.plotFinalStatePlotter,
                                   self.plottingConfig.plotFinalStateArgs, self.plottingConfig.plotFinalStateArgsInit,
                                   self.plottingConfig.plotFinalStateArgsFinal, self.plottingConfig.EPSILON)
