...
class Adr3State( OTObject ):
    ...
    def __init__( self ,
        ...
        OTObject.__init__( self ,
                           N , P )
        if u1 is None:
            self.u1 = grid.StaggeredCenteredField(N,P)
        else:
            self.u1 = u1

        if u2 is None:
            self.u2 = grid.StaggeredCenteredField(N,P)
        else:
            self.u2 = u2

        if u3 is None:
            self.u3 = grid.StaggeredCenteredField(N,P)
        else:
            self.u3 = u3

        if x is None:
            self.x = grid.StaggeredCenteredField(N,P)
        else:
            self.x = x
    ...
    def __add__(self, other):
        if isinstance(other,Adr3State):
            return Adr3State( self.N , self.P ,
